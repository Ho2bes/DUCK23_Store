"""
Django settings for duck23_store project.
...
SECRET_KEY = 'django-insecure-o3vodg$v_htr7e03ryy_(s%hwvjcvkbjxo7oueg2pis6!e_l^b'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:4200',  # Adresse par défaut pour Angular
    'http://127.0.0.1:4200',  # Adresse alternative pour Angular
]
