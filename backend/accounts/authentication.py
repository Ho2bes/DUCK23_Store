...
""""
on hérite de JWTAuthentication pour personnaliser l'authentification
on va récupérer le token JWT depuis les cookies au lieu des headers
on utilise le cookie "accessToken" pour stocker le token JWT
